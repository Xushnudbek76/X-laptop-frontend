      ...
      <Stack sx={{ maxWidth: "1200px", mx: "auto", px: { xs: 2, md: 3 } }}>
        ...
        <Box sx={{ textAlign: "center", mb: 5 }}>
          <Typography sx={{
            ...
            letterSpacing: "3px", textTransform: "uppercase", mb: 1,
          }}>
            Don't Miss Out
          </Typography>
                  ...
                  <Box sx={{
                    ...
                    <Box>
                      <Typography variant="h5" sx={{
                        color: "#ffffff", fontWeight: 800, mb: 1.5,
                    ...
                    <Box sx={{ display: "flex", gap: 1.2, flexWrap: "wrap" }}>
                      <Chip label={value.date} size="small" sx={{
                        background: "rgba(59,130,246,0.15)", color: "#93c5fd",
                        border: "1px solid rgba(59,130,246,0.35)", fontWeight: 600,
                        fontSize: { xs: "0.72rem", sm: "0.8rem" },
                      }} />
                      <Chip label={value.location} size="small" sx={{
                        background: "rgba(59,130,246,0.15)", color: "#93c5fd",
                        border: "1px solid rgba(59,130,246,0.35)", fontWeight: 600,
                        fontSize: { xs: "0.72rem", sm: "0.8rem" },
                      }} />
        ...
        <Box sx={{
          ...
          justifyContent: "center", gap: 3, mt: 4,
        }}>
          <Box
