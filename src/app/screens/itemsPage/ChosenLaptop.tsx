      ...
      <Container maxWidth="lg" sx={{ pt: 2 }}>
        <Stack direction={{ xs: "column", md: "row" }} spacing={4} sx={{ mb: 8 }}>
          ...
          >
            ...
            <Box sx={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 1 }}>
              {specs.map((s) => (
                ...
                >
                  ...
                  <Box sx={{ fontSize: 13, fontWeight: 500, color: "#e8eaf0" }}>{s.value}</Box>
                </Box>
              ))}
            </Box>
            ...
            {/* Description */}
            {item.laptopDesc && (
              <Box sx={{ fontSize: 14, color: "#8892a4", lineHeight: 1.7 }}>{item.laptopDesc}</Box>
            )}
            ...
            <Box sx={{ display: "flex", alignItems: "baseline", gap: 1.5 }}>
              ...
              {item.laptopLeftCount <= 5 && item.laptopLeftCount > 0 && (
                <Box sx={{ fontSize: 12, color: "#f59e0b" }}>Only {item.laptopLeftCount} left</Box>
              )}
            </Box>
          ...
          <Stack spacing={2}>
            {reviews.map((r) => (
              ...
              >
                ...
                <Box sx={{ fontSize: 14, color: "#b0b8cc", lineHeight: 1.65, mb: 1.5 }}>
                  {r.text}
                </Box>
