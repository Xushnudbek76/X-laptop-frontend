    ...
    <Box sx={{ pt: { xs: 10, md: 12 }, pb: 8 }}>
      <Container maxWidth="lg">
        ...
        <Box sx={{ mb: 5 }}>
          ...
          >
            <Typography
              sx={{ fontSize: { xs: "1.6rem", md: "2rem" }, fontWeight: 900, color: "#fff" }}
            >
              All Laptops
            </Typography>
          ...
          >
            ...
            {searchText && (
              <Box
                ...
                sx={{ cursor: "pointer", color: "#64748b", fontSize: 18, lineHeight: 1 }}
              >
                ×
              </Box>
            )}
        ...
        {products.length === 0 ? (
          <Box sx={{ textAlign: "center", py: 10 }}>
            ...
            <Box
              onClick={resetFilters}
              sx={{ mt: 2, color: "#3b82f6", cursor: "pointer", fontSize: 14, fontWeight: 600 }}
            >
              Clear all filters
            </Box>
          </Box>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Typography
                        sx={{ fontSize: { xs: 15, md: 17 }, fontWeight: 800, color: "#3b82f6" }}
                      >
                      ...
                      <Box
                        ...
                        sx={{
                          ...
                          bgcolor: cartAdded.includes(laptop._id)
                            ? "rgba(34,197,94,0.15)"
                            : inStock
                      ...
                      >
                        ...
                        <Box
                          ...
                          sx={{
                            fontSize: 11,
                            fontWeight: 600,
                            color: cartAdded.includes(laptop._id)
                              ? "#4ade80"
                              : inStock
                                ? "#93c5fd"
                                : "#475569",
