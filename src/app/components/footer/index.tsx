    ...
    <Box sx={{ background: "#0a0f1e", pt: 7 }}>
      <Stack sx={{ maxWidth: "1200px", mx: "auto", px: 3 }}>
        ...
        >
          ...
          <Box>
            <Typography
              sx={{ fontSize: "20px", fontWeight: 800, color: "#fff", letterSpacing: "1px", mb: 1.5 }}
            >
              X<span style={{ color: "#3b82f6" }}>-</span>LAPTOP
            </Typography>
            <Typography
              sx={{ fontSize: "13.5px", color: "#64748b", lineHeight: 1.75, mb: 2.5, maxWidth: "260px" }}
            >
              Your trusted destination for premium laptops. Cutting-edge technology, expert reviews, and unbeatable deals — all in one place.
            </Typography>
            ...
            <Box sx={{ display: "flex", alignItems: "center", gap: 1.2 }}>
              ...
              <Typography
                ...
                sx={{ fontSize: "13px", color: "#93c5fd", textDecoration: "none", "&:hover": { textDecoration: "underline" } }}
              >
            ...
            <Box key={title}>
              <Typography
                sx={{
                  ...
                  letterSpacing: "2px", textTransform: "uppercase", mb: 2.2,
                }}
              >
                {title}
              </Typography>
              <Box sx={{ display: "flex", flexDirection: "column", gap: 1.4 }}>
                {links.map((link) => (
                  <Typography
                    ...
                    href="#"
                    sx={{
                      fontSize: "13.5px", color: "#94a3b8", textDecoration: "none",
        ...
        <Box
          sx={{
            ...
            justifyContent: "space-between", py: 2.5,
          }}
        >
