        ...
        <Box sx={{
          ...
          <Box sx={{ textAlign: { xs: "center", md: "left" } }}>
            ...
            <Typography sx={{
              ...
              fontWeight: 900, lineHeight: 1, color: "#ffffff",
            }}>
              X-LAPTOP
            </Typography>
            ...
            <Typography sx={{
              ...
              color: "#3b82f6", // ✅ Blue accent instead of gray
              mb: 3.5,
            }}>
              Precision.
            </Typography>
              ...
              {[
                ...
                <Box key={label} sx={{
                  ...
                  <Typography sx={{
                    ...
                    color: "#64748b", textTransform: "uppercase", mt: 0.25,
                  }}>
                    {label}
                  </Typography>
                </Box>
        ...
        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", px: 2, pb: 1 }}>
          {authMember ? (
            <Box sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
              <Avatar sx={{ width: 32, height: 32, border: "2px solid rgba(59,130,246,0.5)" }} />
              <Box sx={{ fontSize: 13, color: "#e8eaf0" }}>Member</Box>
            </Box>
          ) : <Box />}
